function onCreate()
	-- background shit
	makeLuaSprite('skullroomback', 'skullroomback', -340, -550)
	setLuaSpriteScrollFactor('skullroomback', 0.9, 0.9);
	
	makeLuaSprite('blank', 'blank', -650, 550)
	...
	addLuaSprite('skullroomback', false);
